...
(function($PS) {
  // Generated by purs version 0.13.5
  "use strict";
  $PS["Parallel"] = $PS["Parallel"] || {};
  var exports = $PS["Parallel"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Apply = $PS["Control.Apply"];
  var Control_Bind = $PS["Control.Bind"];
  ...
  var slowAdd = function (a) {
      return function (b) {
          return Data_Functor.map(Effect_Aff.functorAff)(Data_Foldable.sum(Data_Foldable.foldableArray)(Data_Semiring.semiringInt))(Control_Parallel.parSequence(Effect_Aff.parallelAff)(Data_Traversable.traversableArray)([ slowInt(a), slowInt(b) ]));
      };
  };
